...
ListData::ListData() : OtherData(Type::List()), data_() {}

ListData::ListData(data_list_t data) : OtherData(Type::List()), data_(data) {
    size_t i = 0;
...
ListData::ListData(data_vec_t &&data) : OtherData(Type::List()), data_(std::move(data)) {}
