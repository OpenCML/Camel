...
class TaskflowExecSchedPass : public ParallelSchedPass {
  ...
  private:
    ...
    data_ptr_t evalGraphTF(GraphIR::Graph *graph, const frame_rptr_t &frame);
    ...
    template <typename FlowT>
    tf::Task
    buildExitTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildDataTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildPortTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildCopyTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildFillTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildAccsTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildFuncTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildCallTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);

    template <typename FlowT>
    tf::Task
    buildOperTask(FlowT &flowLike, const GraphIR::node_ptr_t &n, const frame_rptr_t &frame);
    ...
    void mark_map_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void mark_apply_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void mark_filter_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void mark_reduce_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void mark_foreach_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void mark_unordered_foreach_arr(
        const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
    void
    mark_unordered_reduce_arr(const GraphIR::node_ptr_t &node, frame_rptr_t frame, tf::Subflow &sf);
};
