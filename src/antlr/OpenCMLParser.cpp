...
void opencmlParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,94,741,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	112,114,116,118,120,122,124,126,128,0,11,1,0,44,45,1,0,53,58,2,0,2,2,
  	15,22,1,0,26,27,2,0,13,14,28,29,1,0,30,31,3,0,3,3,32,34,42,43,2,0,31,
  	31,35,36,2,0,32,32,39,40,1,0,62,71,1,0,81,83,810,0,131,1,0,0,0,2,135,
  	...
  	0,170,169,1,0,0,0,171,172,1,0,0,0,172,173,5,47,0,0,173,174,5,91,0,0,174,
  	...
  	3,114,57,0,562,574,5,93,0,0,563,564,5,6,0,0,564,569,5,93,0,0,565,566,
  	5,8,0,0,566,568,5,93,0,0,567,565,1,0,0,0,568,571,1,0,0,0,569,567,1,0,
  	...
  	0,0,0,584,558,1,0,0,0,584,583,1,0,0,0,585,111,1,0,0,0,586,588,5,93,0,
  	0,587,589,5,90,0,0,588,587,1,0,0,0,588,589,1,0,0,0,589,601,1,0,0,0,590,
  	592,5,94,0,0,591,593,5,90,0,0,592,591,1,0,0,0,592,593,1,0,0,0,593,601,
  	1,0,0,0,594,601,5,91,0,0,595,601,5,88,0,0,596,601,5,92,0,0,597,601,5,
  	60,0,0,598,601,5,61,0,0,599,601,5,59,0,0,600,586,1,0,0,0,600,590,1,0,
  	...
  	0,611,613,5,6,0,0,612,614,5,93,0,0,613,612,1,0,0,0,613,614,1,0,0,0,614,
  	...
  	0,0,0,644,649,5,72,0,0,645,646,5,13,0,0,646,647,3,114,57,0,647,648,5,
  	14,0,0,648,650,1,0,0,0,649,645,1,0,0,0,649,650,1,0,0,0,650,735,1,0,0,
  	0,651,658,5,73,0,0,652,653,5,13,0,0,653,654,3,114,57,0,654,655,5,8,0,
  	0,655,656,3,114,57,0,656,657,5,14,0,0,657,659,1,0,0,0,658,652,1,0,0,0,
  	658,659,1,0,0,0,659,735,1,0,0,0,660,735,5,74,0,0,661,735,5,75,0,0,662,
  	671,5,76,0,0,663,664,5,13,0,0,664,667,3,114,57,0,665,666,5,8,0,0,666,
  	668,5,93,0,0,667,665,1,0,0,0,667,668,1,0,0,0,668,669,1,0,0,0,669,670,
  	5,14,0,0,670,672,1,0,0,0,671,663,1,0,0,0,671,672,1,0,0,0,672,735,1,0,
  	0,0,673,682,5,77,0,0,674,676,5,13,0,0,675,677,3,44,22,0,676,675,1,0,0,
  	...
  	1,0,0,0,683,735,1,0,0,0,684,693,5,78,0,0,685,687,5,13,0,0,686,688,3,44,
  	...
  	685,1,0,0,0,693,694,1,0,0,0,694,735,1,0,0,0,695,700,5,79,0,0,696,697,
  	5,13,0,0,697,698,3,114,57,0,698,699,5,14,0,0,699,701,1,0,0,0,700,696,
  	1,0,0,0,700,701,1,0,0,0,701,735,1,0,0,0,702,720,5,80,0,0,703,704,5,13,
  	0,0,704,716,3,114,57,0,705,706,5,8,0,0,706,707,5,6,0,0,707,712,5,93,0,
  	0,708,709,5,8,0,0,709,711,5,93,0,0,710,708,1,0,0,0,711,714,1,0,0,0,712,
  	...
  	737,7,10,0,0,737,127,1,0,0,0,738,739,5,89,0,0,739,129,1,0,0,0,100,131,
...
OpenCMLParser::ProgramContext* OpenCMLParser::program() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 4611527793979697760) != 0) || ((((_la - 88) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 88)) & 123) != 0)) {
      setState(130);
      stmtList();
    }
...
OpenCMLParser::BracedValuesContext* OpenCMLParser::bracedValues() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 4602678924399356480) != 0) || ((((_la - 88) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 88)) & 123) != 0)) {
      setState(370);
      valueList();
    }
  ...
  try {
    ...
    case 6: {
      ...
      case 1: {
        ...
        _la = _input->LA(1);
        if ((((_la & ~ 0x3fULL) == 0) &&
          ((1ULL << _la) & -4044232465378694656) != 0) || ((((_la - 64) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 64)) & 34603007) != 0)) {
          setState(675);
          typeList();
        }
        setState(679);
