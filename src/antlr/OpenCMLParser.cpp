...
void opencmlParserInitialize() {
  ...
  static const int32_t serializedATNSegment[] = {
  	4,1,93,777,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,2,5,7,5,2,6,7,6,2,
  	...
  	0,0,635,637,5,92,0,0,636,638,5,89,0,0,637,636,1,0,0,0,637,638,1,0,0,0,
  	638,650,1,0,0,0,639,641,5,93,0,0,640,642,5,89,0,0,641,640,1,0,0,0,641,
  	642,1,0,0,0,642,650,1,0,0,0,643,650,5,90,0,0,644,650,5,87,0,0,645,650,
  	5,91,0,0,646,650,5,59,0,0,647,650,5,60,0,0,648,650,5,58,0,0,649,635,1,
  	...
  	5,9,0,0,743,745,5,92,0,0,744,742,1,0,0,0,744,745,1,0,0,0,745,746,1,0,
  	...
  	753,754,5,9,0,0,754,755,5,7,0,0,755,760,5,92,0,0,756,757,5,9,0,0,757,
  	759,5,92,0,0,758,756,1,0,0,0,759,762,1,0,0,0,760,758,1,0,0,0,760,761,
  	...
  	1,0,0,0,771,115,1,0,0,0,772,773,7,2,0,0,773,117,1,0,0,0,774,775,5,88,
...
OpenCMLParser::ProgramContext* OpenCMLParser::program() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 2305717664888132800) != 0) || ((((_la - 87) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 87)) & 123) != 0)) {
      setState(120);
      stmtList();
    }
  ...
  try {
    ...
    switch (_input->LA(1)) {
      case OpenCMLParser::LET: {
        ...
        _la = _input->LA(1);
        if ((((_la & ~ 0x3fULL) == 0) &&
          ((1ULL << _la) & 2296851203121747076) != 0) || ((((_la - 87) & ~ 0x3fULL) == 0) &&
          ((1ULL << (_la - 87)) & 123) != 0)) {
          setState(152);
          _errHandler->sync(this);
...
OpenCMLParser::RetStmtContext* OpenCMLParser::retStmt() {
  ...
  try {
    ...
    _la = _input->LA(1);
    if ((((_la & ~ 0x3fULL) == 0) &&
      ((1ULL << _la) & 2296851203121747072) != 0) || ((((_la - 87) & ~ 0x3fULL) == 0) &&
      ((1ULL << (_la - 87)) & 123) != 0)) {
      setState(221);
      entityExpr(0);
    }
