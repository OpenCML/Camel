...
//         node_ptr_t declNode = createNodeAs<DeclLoad>(funcType);
//         *execNode << declNode;
//     }
...
//         node_ptr_t nRefNode = createNodeAs<NRefLoad>(ident);
...
//     node_ptr_t declNode = createNodeAs<DeclLoad>(funcType);
//     const auto funcNode = createNodeAs<FuncLoad>(funcType);
...
//     enter("RetStmt");
//     node_ptr_t retNode = createNodeAs<RetnLoad>();
...
//     } else {
//         node_ptr_t exprNode = any_cast<node_ptr_t>(visitEntityExpr(context->entityExpr()));
//         node_ptr_t returnNode = createNodeAs<RetnLoad>();
//         node_ptr_t execNode = createNodeAs<ExecLoad>();
//         *returnNode << exprNode;
//         *execNode << returnNode;
//         bodyNode = execNode;
...
//     const auto declNode = createNodeAs<DeclLoad>(funcType);
//     const auto funcNode = createNodeAs<FuncLoad>(funcType);
...
//             }
//             node_ptr_t dataNode = createNodeAs<DataLoad>(paramsPtr);
//             node_ptr_t linkNode = createNodeAs<LinkLoad>();
...
//     case 1: { // identRef
//         const string &ident = any_cast<string>(visitIdentRef(context->identRef()));
//         res = createNodeAs<DRefLoad>(ident);
//     } break;
//     case 2: { // literal
...
//         make_shared<ListData>(); bool dangling = false; node_ptr_t execNode = createNodeAs<ExecLoad>(); for (const auto
//         &node : dataVec) {
//             auto [data, _] = extractData(node, execNode, dangling);
//             listData->emplace(data);
//         }
//         node_ptr_t dataNode = createNodeAs<DataLoad>(listData);
//         if (dangling) {
...
//         }
//         node_ptr_t dataNode = createNodeAs<DataLoad>(dictData);
//         if (dangling) {
//             res = reparent(dataNode, execNode);
//         } else {
//             res = dataNode;
...
//         }
//         node_ptr_t dataNode = createNodeAs<DataLoad>(tuplePtr);
//         if (dangling) {
//             dataNode = reparent(dataNode, execNode);
//         }
//         res = dataNode;
...
//                     }
//                     node_ptr_t dataNode = createNodeAs<DataLoad>(vectorPtr);
//                     if (dangling) {
//                         dataNode = reparent(dataNode, execNode);
//                     }
//                     res = dataNode;
...
//                     }
//                     node_ptr_t dataNode = createNodeAs<DataLoad>(arrayPtr);
//                     if (dangling) {
//                         dataNode = reparent(dataNode, execNode);
//                     }
//                     res = dataNode;
...
//                     node_ptr_t dataNode = createNodeAs<DataLoad>(tensorPtr);
//                     if (dangling) {
//                         dataNode = reparent(dataNode, execNode);
//                     }
//                     res = dataNode;
...
//                     setPtr->emplace(data);
//                 }
//                 node_ptr_t dataNode = createNodeAs<DataLoad>(setPtr);
//                 if (dangling) {
//                     dataNode = reparent(dataNode, execNode);
//                 }
//                 res = dataNode;
...
//                 res = createNodeAs<DataLoad>(mapData);
//             }
...
//             }
//             node_ptr_t dataNode = createNodeAs<DataLoad>(mapPtr);
//             if (dangling) {
//                 dataNode = reparent(dataNode, execNode);
//             }
//             res = dataNode;
